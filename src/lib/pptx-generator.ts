...
export async function generatePPTXBuffer(currentMonth: number, currentYear: number): Promise<Buffer> {
  ...
  slide1.addText("Weekly Photocopier Usage Report", { x: 0.5, y: 4.1, w: 7.0, h: 0.6, fontSize: 26, color: "b52025", bold: true, align: "left", valign: "middle" });
  slide1.addText(`${months[currentMonth-1]} ${currentYear}`, { x: 0.5, y: 4.7, w: 7.0, h: 0.5, fontSize: 24, color: "b52025", italic: true, align: "left", valign: "middle" });

  // Slide 2: Executive Summary
  const slide2 = pptx.addSlide({ masterName: "MASTER_SLIDE" });
  slide2.addText("Executive Summary", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slideSummary.addText("Usage & Cost Summary", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slide3.addText("Usage Trends: Monthly & Weekly", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slide4.addText("Cumulative Usage (YTD & MTD)", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slide5.addText("Historical Distribution Analysis", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slide6.addText("Top 5 Users & Departments", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slide6Detail.addText("Top 5 Departments Detail", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
  ...
  slide7.addText("Estimated Monthly Cost Analysis", { x: 0.4, y: 0.78, w: "90%", h: 0.5, fontSize: 24, bold: true, color: "FFFFFF", valign: "middle" });
